...
//        let lblFrame = CGRect(x: , y: <#T##Double#>, width: <#T##Double#>, height: <#T##Double#>)
...
//
//            let touchPoint = touch.location(in: strText)
//            let DynamicView = UIView.init(frame: CGRect(x: touchPoint.x, y: touchPoint.y, width: 120, height: 50))//(frame: CGRectMake(touchPoint.x, touchPoint.y, 100, 100))
